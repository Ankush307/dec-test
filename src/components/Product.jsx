                    ...
                    <div className="d-flex grid-container justify-content-center align-items-center w-100 h-100">
                        <div className="d-grid grid-box h-100 max-sm-center ">
                            ...
                            <div className="grid-content-2 d-flex">
                                <img className="card-image-small" src='/assets/images/png/card-img3.png' alt="GridThree" />
                                <img className="card-image-large" src='/assets/images/png/card-img4.png' alt="GridFour" />
                            </div>
                            <div className="grid-content-3 d-flex">
                                <img className="card-image-large" src='/assets/images/png/card-img5.png' alt="GridOne" />
                                <img className="card-image-small" src='/assets/images/png/card-img6.png' alt="GridTwo" />
                            </div>
                            <div className="grid-content-4 d-flex">
                                <img className="card-image-large" src='/assets/images/png/card-img7.png' alt="GridThree" />
                                <img className="card-image-small" src='/assets/images/png/card-img8.png' alt="GridFour" />
                            </div>
                            <div className="grid-content-5 d-flex">
                                <img className="card-image-small" src='/assets/images/png/card-img9.png' alt="GridOne" />
                                <img className="card-image-large" src='/assets/images/png/card-img10.png' alt="GridTwo" />
                            </div>
                            <div className="grid-content-6 d-flex">
                                <img className="card-image-small" src='/assets/images/png/card-img11.png' alt="GridThree" />
                                <img className="card-image-large" src='/assets/images/png/card-img12.png' alt="GridFour" />
                            </div>
                        </div>
                    </div>
                </div>

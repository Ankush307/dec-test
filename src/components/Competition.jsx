        ...
        <div className="bg-Bluish-purple align-content-center h-screen py-5">
            <div className="container">
                <div className="row justify-content-center">
                    ...
                    <div className='col-xl-6 table-responsive d-flex table-bg border-radius-xl'>
                            ...
                            <table className='Competition-table'>
                                ...
                                <tbody>
                                    {COMPETITION_LIST.map((obj, i) => (
                                        <tr key={i}>
                                            <td className={`text-white fw-normal table-data bg-transparent custom-border-b-none`}>{obj.feature}</td>
                                            ...
                                            <td className={`text-center bg-lightGreen table-data custom-border-b-none ${i === 5 ? 'fees-year border-bottom-radius' : ''}`}>{obj.pie}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
